; *** Persian Proxy (English Interface) ***

[LangOptions]
LanguageName=فارسی (English)
LanguageID=$0429
...
LdrCannotCreateTemp=Setup is unable to create a temporary file. Setup aborted
LdrCannotExecTemp=Setup is unable to execute a file in the temporary directory. Setup aborted
HelpTextNote=
...
NotOnThisPlatform=This program cannot run on %1.
...
; *** Misc. errors
ErrorCreatingDir=Setup is unable to create the directory "%1"
...
PasswordLabel3=Please read the following important information before continuing.
...
BadDirName32=The folder name cannot include any of the following characters:%n%n%1
...
NoUninstallWarningTitle=Component Exists
...
DownloadingLabel2=Downloading additional files...
...
ArchiveIncorrectPassword=The password specified is incorrect
ArchiveIsCorrupted=The file is corrupted
ArchiveUnsupportedFormat=The archive format is not supported
...
VerificationKeyNotFound=The signature file "%1" used an unknown key
...
FileExistsOverwriteOrKeepAll=&Do this for all conflicts
...
ExistingFileNewerOverwriteOrKeepAll=&Do this for all conflicts
...
ErrorExtracting=An error occurred while trying to extract a file:
...
ConfirmDeleteSharedFile2=The system indicates that the following shared file is no longer in use by any programs. Would you like for Uninstall to remove this shared file?%n%nIf there are any programs that still use this file and it is removed, those programs may not function properly. If you are unsure, choose No. Leaving the file on your system will not cause any harm.
...
CreateSchedulerTask=Create Task Scheduler (for auto-start distros, USB auto-connect, port forwarding)
SchedulerTaskNote1=└ Optional during installation; skipping does not affect future use.
...
CleanupData=Delete user configuration and logs: ~\.wsldashboard
StartMenuIcon=Create Start Menu folder (including startup and uninstall shortcuts)
VisitWebsite=Visit Official Website
UninstallerName=%1 Uninstaller
